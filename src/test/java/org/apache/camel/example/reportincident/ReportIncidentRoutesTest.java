...
public class ReportIncidentRoutesTest {
    ...
    protected void runTest() throws Exception {
        ...
        XMLGregorianCalendar date = DatatypeFactory.newInstance().newXMLGregorianCalendar("2008-08-18");
        input.setIncidentPriority(Priority.LOW);
        input.setIncidentDate(date);
